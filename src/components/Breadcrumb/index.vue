<template>
  <el-breadcrumb class="app-breadcrumb breadcrum-container" separator="/">
...
const getBreadcrumb = () => {
  ...
  levelList.value = matched.filter(
    (item) => item.meta && item.meta.title && item.meta.breadctumb !== false
  )
}
watch(
  () => route.path,
...
const handlerLink = (route: PartialRouteLocationMatched) => {
  // console.log(route, "handlerLink")
